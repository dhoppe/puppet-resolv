...
define resolv::define (
  ...
  $config_file_options_hash = $::resolv::config_file_options_hash,
) {
  ...
  $_config_file_path  = pick($config_file_path, "${::resolv::config_dir_path}/${name}")
  $_config_file_owner = pick($config_file_owner, $::resolv::config_file_owner)
  $_config_file_group = pick($config_file_group, $::resolv::config_file_group)
  $_config_file_mode = pick($config_file_mode, $::resolv::config_file_mode)
  $config_file_content = default_content($config_file_string, $config_file_template)

#  $_config_file_require = pick($config_file_require, $::resolv::config_file_require)
